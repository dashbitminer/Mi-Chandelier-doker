<template>
  ...
  <main>
    <ChandelierPage class="mt-8">
      <AreaTitle>Nueva clase</AreaTitle>
...
const onSubmit = (values) => {
  ...
  form.require_evaluation = values.require_evaluation ? true : false;
...
const submitTopic = () => {
  ...
  router.post(route('elearning.courses.topics.store', { course: props.course.id, country: currentCountry.value }), {
    data: formData,
  }, {
    preserveState: true,
  });
