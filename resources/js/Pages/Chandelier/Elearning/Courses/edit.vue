<template>
  ...
  <main>
    <ChandelierPage class="mt-8">
      <AreaTitle>Editar Curso</AreaTitle>
...
const form = reactive({
  ...
  scope: props.course.scope,
  course_type: props.course.course_type,
  selectedCountries: props.selectedCountries,
  selectedCountryProjects: props.selectedCountryProjects
})
...
const submitCourse = () => {
  router.put(route('elearning.courses.update', { course: props.course.id, country: currentCountry.value }), {
    data: form,
  }, {
    preserveState: true,
  });
